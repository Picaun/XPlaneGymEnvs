"""
XPlaneDiscreteEnv - X-Plane Environment with Discrete Action Space

This environment uses a discrete action space, specifically optimized for reinforcement learning algorithms
based on discrete actions such as DQN.
"""
...
class XPlaneDiscreteEnv(XPlaneEnv):
    """X-Plane Environment with Discrete Action Space
    
    Provides 9 discrete actions (no action, pitch up/down, roll left/right, rudder left/right, throttle up/down),
    suitable for reinforcement learning algorithms based on discrete action spaces such as DQN, Q-learning, etc.
    """
